...
flags.DEFINE_string("data_dir", "data/chinese", "Data dir [data/squad]")
...
flags.DEFINE_string("out_channel_dims", "1", "Out channel dims of Char-CNN, separated by commas [100]")
flags.DEFINE_string("filter_heights", "1", "Filter heights of Char-CNN, separated by commas [5]")
